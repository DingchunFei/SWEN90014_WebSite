...
public interface WebAppService {
    ...
    public User insertWebApp(WebApp webApp,String[] emails, Integer round, String[][] targets,String[][] nearDistractors,String[][] farDistractors, Integer[] grid_row, Integer[] grid_column);                    //由于每次插入新的webApp URL也需要检查，因此要多一个URL参数
